...
function Model({ open, hinge, ...props }) {
 ...
 function Scene() {
  ...
  return (
    <web.main style={{ background: props.open.to([0, 1], ['#f0f0f0', '#d25578']),height: '39vh' }}>
      <web.h1 style={{ opacity: props.open.to([0, 1], [1, 0]), transform: props.open.to((o) => `translate3d(12%,${80}px,0)`) }}>Click on Laptop</web.h1>
